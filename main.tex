...
\item[]\textbf{Scientific Computing:} neuroimaging/MRI segmentation, astronomical image processing (FITS, Astropy, Photutils), CCD calibration, differential photometry, time-domain imaging, deep learning inference workloads and compute planning, GIS analysis, QGIS visualization, geocoding/FIPS recovery
